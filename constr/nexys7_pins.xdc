...
## LEDs
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports i2c_done_o]
...
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports ad_o]
...
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports sda_io]
